...
なお、本記事で紹介するアプローチは [`android/nav3-recipes`](https://github.com/android/nav3-recipes) の [#242](https://github.com/android/nav3-recipes/pull/242) にて、公式のレシピとしては採用されませんでした。しかし、Nav3 の設計の自由度や仕組みを理解する上では有用な視点であるため、独自のアプローチとして紹介します。
