---
title: 'LocalSnackbarHostState: CompositionLocalによるSnackbarHostStateの管理方法'
tags:
  - Android
  - Kotlin
  - SnackBar
...
`Scaffold` を含むComposable関数で `LocalSnackbarHostState`を提供し、その下位のComposable 関数から `SnackbarHostState` を利用できるようにします。
